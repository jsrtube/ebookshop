...
if(isset($_POST['send'])){
   ...
   $m_other = $_POST['other'];
   $m_to = $_SESSION['chat_session'];
   $m_send = "INSERT INTO chat (c_to,message,c_from,other) VALUES ('$m_to','$message_s','teacher','$m_other')";
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Admin JSR</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Govind Kumawat</a>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <div class="card bg-gradient-info">
              ...
              <?php include 'dash_chart_display.php'; ?>
			  </div>
            ...
            <div class="card direct-chat direct-chat-primary">
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
				  ...
				  <?php 
				  include'connection.php';
				  $search_c = "SELECT * FROM chat ORDER BY time_s";
				  ...
				  while($data_c = mysqli_fetch_array($query_c)){
                    ...
                    <div class="direct-chat-text">
                      <?php echo $data_c['message'];?> <b class="float-right"><?php echo $data_c['c_to'];?></b>
                    </div>
                    <!-- /.direct-chat-text -->
                  </div>	
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <?php 
				  include'connection.php';
				  $search_u = "SELECT * FROM user_reg";
				  $query_u = mysqli_query($conn,$search_u);
                        ...
                        <div class="contacts-list-info">
                          <span class="contacts-list-name">
							...
							<form action="" method="POST">
							    <input type="hidden" name="user_send" value="<?php echo $data_u['username'];?>" />
								<input class="btn-success" type="submit" name="submit" value="call">
							</form>
							</small>
                          </span>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="https://adminlte.io">Jsr Smart E-book</a>.</strong>
    All rights reserved.
